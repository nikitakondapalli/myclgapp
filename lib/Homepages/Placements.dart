                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Expanded(
                            child: Image.asset("assets/images/placements1.png",
                                height: 220)),
                        SizedBox(
                          width: 20,
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                "THIGULLA SAMPATH REDDY",
                                style: TextStyle(
                                    fontFamily: "Raleway", fontSize: 19),
                              ),
                              Text(
                              ...
                              Expanded(
                                child: Row(
                                  children: <Widget>[
                                    GestureDetector(
                                      onTap: () {
                                        customLaunch("mailto:cro@nnrg.edu.in?");
                                      },
                                      child: IconTile(
                    ...
                    Text(
                      "About",
                      style: TextStyle(fontSize: 22, fontFamily: 'Raleway'),
                    ),
                    SizedBox(
                      height: 16,
                    ),
                    Text(
                      "Mr. Sampath Reddy Thigulla is creative and highly result oriented engineering professional who brings "
                    ...
                    Text(
                      "Worked in IT for around five years with one year in India and around four years in USA.",
                      style: TextStyle(
                          color: Colors.black45,
                          fontSize: 15,
                          fontFamily: 'SourceSansPro'),
